...
import framework.db
from models.enphase import Base
from api import health, info, enphase
...
app = FastAPI(
    title="Enphase API",
    version="1.0.0",
    openapi_url="/api/v1/enphase/openapi.json",
    docs_url="/api/v1/enphase/docs",
    lifespan=lifespan
)
...
app.include_router(enphase.router, tags=["enphase"])
app.mount("/enphase/test", StaticFiles(directory="static", html=True), name="test")
